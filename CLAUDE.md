...
Satıcı yanındaki kişi
  → Linux  : curl -fsSL https://tirekicker-relay.gentle-heart-33fd.workers.dev | bash
    Windows: irm https://tirekicker-relay.gentle-heart-33fd.workers.dev/win | iex   (PowerShell, Run as Administrator)
...
- [x] **Adım 3 + 4** — Tek CF Worker multi-path, `tirekicker-relay.gentle-heart-33fd.workers.dev`
...
- [ ] **Adım 5e** — Worker deploy + `tirekicker-relay.gentle-heart-33fd.workers.dev` route bind
